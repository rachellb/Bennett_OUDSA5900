...
if __name__ == "__main__":
    ...
    filename = 'Results/Texas/Full/Hyperband/Outliers/CustomLoss/Test_ClassProportionWeights'
    modelWeighted = NN(filename)
    ...
    auc, gmean, precision, recall, specificity, tp, fp, tn, fn = modelWeighted.evaluateModel()
